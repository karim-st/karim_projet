  ...
  if (isText) {
    return (
      <div className="flex h-full w-full items-center gap-1 rounded border border-transparent px-1 hover:border-[#9eb1c8]">
        <div className={`annotation-drag-handle flex cursor-move items-center ${darkMode ? "text-[#8ea2bd]" : "text-[#718197]"}`} title="Déplacer le texte" aria-label="Déplacer le texte">
        ...
        <input
          ...
          style={{
            color: data?.ui?.color ?? (darkMode ? "#e5eaf2" : "#263548"),
